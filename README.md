...
- **PPG Signal Analysis** – Using **wearable tech** to detect sleep disorders 

##  Tech Stack:
- **Frontend:** `React.js`, `JavaScript`, `HTML5`, `CSS3` – Making the web beautiful and interactive 
- **Backend:** `Node.js`, `Express`, `Go` – Building robust APIs and handling data like a pro 
